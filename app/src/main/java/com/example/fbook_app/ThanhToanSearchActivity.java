...
public class ThanhToanSearchActivity extends AppCompatActivity {
    ...
    private void sendNotificationFail() {
        ...
        Intent intent = new Intent(ThanhToanSearchActivity.this, com.example.fbook_app.HomeActivity.Notification.Notification.class);
        TaskStackBuilder stackBuilder=TaskStackBuilder.create(ThanhToanSearchActivity.this);
