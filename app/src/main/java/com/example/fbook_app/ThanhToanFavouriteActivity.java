...
public class ThanhToanFavouriteActivity extends AppCompatActivity {
    ...
    private void setData() {
        ...
        tvNameBook.setText(Common.currentFavouriteBook.getBookName());
        String price = Common.currentFavouriteBook.getPriceBook() + " vnđ";
        ...
        btnThanhToan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressDialog dialog = new ProgressDialog(ThanhToanFavouriteActivity.this);
    ...
    private void thanhtoanZalo(String status, int iDBook, int priceTotal, String createAt) {
        ...
        try {
            ...
            if (code.equals("1")) {
                ...
                ZaloPaySDK.getInstance().payOrder(ThanhToanFavouriteActivity.this, token, "demozpdk://app", new PayOrderListener() {
                    @Override
