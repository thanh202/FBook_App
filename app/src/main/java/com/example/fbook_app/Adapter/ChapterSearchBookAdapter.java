...
public class ChapterSearchBookAdapter extends RecyclerView.Adapter<ChapterSearchBookAdapter.ViewHolder> {
    private OnItemClickListener onItemClickListener;
    private final Context context;
    private Boolean isSelected = false;
    private List<Integer> bookList = new ArrayList<>();
    public ChapterSearchBookAdapter(Context mContext){
        context = mContext;
    }
    public void setOnItemClickListener(OnItemClickListener itemClickListener){
        this.onItemClickListener = itemClickListener;
    }
    public void setListChapterBook(SearchResponse.Result book){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_chapter_search_book,parent,false);
