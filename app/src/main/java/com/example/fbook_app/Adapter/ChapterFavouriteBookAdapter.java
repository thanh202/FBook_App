...
public class ChapterFavouriteBookAdapter extends RecyclerView.Adapter<ChapterFavouriteBookAdapter.ViewHolder> {
    private OnItemClickListener onItemClickListener;
    private final Context context;
    private Boolean isSelected = false;
    private List<Integer> bookList = new ArrayList<>();

    public ChapterFavouriteBookAdapter(Context mContext) {
        context = mContext;
    }
    ...
    public void setListChapterBook(ListFavouriteResponse.Result book) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_chapter_favourite_book, parent, false);
